...
Route::group([
    ...
    Route::get('index', [usersController::class, 'index']);       //ruta para hacer el login del sitio web como parametros esta ruta nesesita el email y el password para poder realizar el logueo y devolver el token del usuario
    Route::post('store', [usersController::class, 'store']);
    Route::post('contrato', [usersController::class, 'contrato']);
